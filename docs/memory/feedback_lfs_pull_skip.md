...
**Why:** 四个目录（OHOS2~OHOS5）的源码都是从 `/data/<user>/OHOS5/ohos5_2026_03_14.tar.gz` 解压的，LFS 对象已完整存在于本地，无需重新拉取。该步骤每次耗时 15-30 分钟，属于冗余操作。
...
```bash
# 以 OHOS2 为例
rm -Rf /data/<user>/OHOS2/ohos5
cd /data/<user>/OHOS2
tar -xf /data/<user>/OHOS5/ohos5_2026_03_14.tar.gz
```

**tar.gz 位置**：`/data/<user>/OHOS5/ohos5_2026_03_14.tar.gz`（55G，2026-03-14 基线）
